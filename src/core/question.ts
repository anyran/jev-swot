...
const RESULT_ANNOTATION_RE = /(?:正确答案|参考答案|答案解析|解析|得分|得分情况|你的答案|作答结果|提交结果|判定结果|correct\s+answer|reference\s+answer|answer\s+explanation|explanation|score|your\s+answer|submission\s+result|result)\s*(?:[:：]|是|为|is|was|=)/i;
