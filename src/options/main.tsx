...
function App() {
  ...
  </form><aside>快捷键：Ctrl/Command + Shift + Y 框选；冲突时可用 Windows/Linux: Alt + Shift + Y；macOS: Command + Shift + U；Alt + 双击识别当前题目。若题目依赖截图，浏览器需要快捷键授予临时截图权限，请改用框选快捷键。插件不会自动选择或提交答案。</aside></main>;
}
